...
client.on("guildMemberRemove", member => {
 ...
 ~~#~~ 1 - \`${prefix}invites\` : To know the number of invitations
 ~~#~~ 2 - \`${prefix}config joinMessageChannel\` : room to be sent if someone entered
 ~~#~~ 3 - \`${prefix}config leaveMessageChannel\` : room if someone goes out there
 ~~#~~ 4 - \`${prefix}config show \` : Tell you the information you did
 ~~#~~ 5 - \`${prefix}config reset-invites\` : clear Member invitations
 ~~#~~ 6 - \`${prefix}config resetall-invites\` : Clear all members invitations
 ~~#~~ 7 - \`${prefix}config add-invites\` : Add invitations to a member
 ~~#~~ 8 - \`${prefix}config prefix\` : To change the bot prefix
**
\`By : Me Codes\``);
